        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-cascade narrower">
                        <div class="row justify-content-center align-items-center" style="padding: 80px">
                                <i class="far fa-check-circle" style="color: rgb(22, 224, 107)" ></i> 
                        <h3 style="color: rgb(22, 224, 107)">Платеж принят!</h3>
                    </div>
                </div>
            </div>
        </div>
